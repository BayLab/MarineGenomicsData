...
```{r two, echo=FALSE }
knitr::include_graphics("./fig/redirects-and-pipes.svg") 
```
...
```{r three, echo=FALSE}
knitr::include_graphics("./fig/shell_script_for_loop_flow_chart.svg")
```
...
```{r four, echo=FALSE}
knitr::include_graphics("./fig/find-file-tree.svg")
```
